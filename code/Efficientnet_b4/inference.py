...
def inference(data_dir, model_dir, output_dir, args):
    ...
    img_root = os.path.join(data_dir, 'crop_hist_eval_images')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_CHANNEL_MODEL', '/opt/ml/code/Efficientnet-B4/model/exp/last9.pth')) #####
    parser.add_argument('--output_dir', type=str, default=os.environ.get('SM_OUTPUT_DATA_DIR', '/opt/ml/code/Efficientnet-B4/model/exp'))
