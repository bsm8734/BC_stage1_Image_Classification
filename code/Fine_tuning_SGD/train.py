...
def train(data_dir, model_dir, args):
    csv_path = model_dir + '/' + 'validation_score_log.csv'
    ...
    model.load_state_dict(torch.load('/opt/ml/code/Efficientnet-B4/model/fine_exp2/last1.pth', map_location=device))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=515, help='random seed (default: 42)')
    ...
    parser.add_argument('--val_ratio', type=float, default=0.00001, help='ratio for validaton (default: 0.2)')
    parser.add_argument('--criterion', type=str, default='cross_entropy', help='criterion type (default: cross_entropy)')
    parser.add_argument('--lr_decay_step', type=int, default=20, help='learning rate scheduler deacy step (default: 20)')
    parser.add_argument('--log_interval', type=int, default=20, help='how many batches to wait before logging training status')
    parser.add_argument('--name', default='fine_exp3', help='model save at {SM_MODEL_DIR}/{name}')

    # Container environment
    parser.add_argument('--data_dir', type=str, default=os.environ.get('SM_CHANNEL_TRAIN', '/opt/ml/input/data/train/images'))
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_MODEL_DIR', '/opt/ml/code/Efficientnet-B4/model'))
