...
def train(data_dir, model_dir, args):
    ...
    # model.load_state_dict(torch.load('/opt/ml/code/Efficientnet-B4/model/(1)exp/best.pth', map_location=device))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=14, help='input batch size for training (default: 64)')
    parser.add_argument('--valid_batch_size', type=int, default=400, help='input batch size for validing (default: 1000)')
    ...
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_MODEL_DIR', '/opt/ml/code/Resnet50/model'))
